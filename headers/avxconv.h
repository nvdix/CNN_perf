...
// Класс c AVX оптимизацией расчёта свёртки
class AVXConv : public BaseConv
{
public:
    AVXConv(ConvData *conv);

    AVXConv(CONV_TYPE type, int tensor_height, int tensor_width, int height, int width, int inputs = 1,
